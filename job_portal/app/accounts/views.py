...
class ProfileAPI(APIView):
    ...
    def put(self, request):
        ...
        if serializer.is_valid():
            serializer.save()
            # Also update auto_apply_enabled which is not in UserSerializer fields originally? 
            # Wait, let's check if auto_apply_enabled and skills are in UserSerializer fields.
            return Response(serializer.data)
        return Response(serializer.errors, status=status.HTTP_400_BAD_REQUEST)